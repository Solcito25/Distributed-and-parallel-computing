...
void Get_dims(
   ...
   MPI_Bcast(m_p, 1, MPI_INT, 0, comm);// envia los datos recibidos en el proceso 0 a todos
...
void Read_matrix(
   ...
   if (my_rank == 0) {
      ...
      MPI_Scatter(A, local_m*n, MPI_DOUBLE, 
            ...
            local_A, local_m*n, MPI_DOUBLE, 0, comm);//envia por partes a los otros procesos
...
void Print_matrix(
   ...
   if (my_rank == 0) {
      ...
      MPI_Gather(local_A, local_m*n, MPI_DOUBLE,
            ...
            A, local_m*n, MPI_DOUBLE, 0, comm);//recolecta todo en un vector
...
void Mat_vect_mult(
   ...
   MPI_Allgather(local_x, local_n, MPI_DOUBLE,
         ...
         x, local_n, MPI_DOUBLE, comm);//rcolecta todo y lo almacena en cada proceso
